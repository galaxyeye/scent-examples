select
    ...
    cast(dom_all_texts(dom, '#usedbuyBox div:contains(Sold by) a[href~=seller], #merchant-info a[href~=seller], #buybox-tabular a[href~=seller]') as varchar) as `soldby`,
    ...
    dom_attr(dom_owner_body(dom), '_ps_num_total_variations') as `totalvariations`,
