...
select
    ...
    dom_first_number(dom, 'div.a-section:expr(a>0) span[aria-label~=star] i span', 0.0) as score,
    ...
    dom_first_text(dom, 'div.ignore-ajax-load') as `score5percent`,
    dom_first_text(dom, 'div.ignore-ajax-load') as `score4percent`,
    dom_first_text(dom, 'div.ignore-ajax-load') as `score3percent`,
    dom_first_text(dom, 'div.ignore-ajax-load') as `score2percent`,
    dom_first_text(dom, 'div.ignore-ajax-load') as `score1percent`,
