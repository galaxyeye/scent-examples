...
select
    ...
    str_substring_between(dom_first_href(dom, 'div.a-section > a'), '/dp/', '/ref=') as ad_asin,
    str_substring_between(dom_first_href(dom, 'div.a-section > a'), '/dp/', '/ref=') as ad_asin_bsr,
    ...
    dom_first_text(dom, 'div.a-section > div a:contains(out of 5 stars)') as ad_asin_starnum
