...
select
    ...
    dom_first_number(dom, 'div.a-row:expr(a>0) i[class~=a-icon-star]', 0.0) as score,
    dom_first_text(dom, 'div.a-row:expr(a>0) span[name] ~ a') as starnum,
    'N/I' as `reviews`,
    ...
    'N/I' as `score5percent`,
    'N/I' as `score4percent`,
    'N/I' as `score3percent`,
    'N/I' as `score2percent`,
    'N/I' as `score1percent`,
