...
var $url = 'http://119.45.149.30:8182/api/x/sql/json';
var $curl = curl_init($url);
curl_setopt($curl, CURLOPT_RETURNTRANSFER, true);
curl_setopt($curl, CURLOPT_HTTPHEADER, array( 'Content-Type: application/json', 'Content-length:' . strlen($sql))); // check if the length be correct
